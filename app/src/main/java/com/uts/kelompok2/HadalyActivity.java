...
public class HadalyActivity extends AppCompatActivity {
    TextView mTitleHadaly,mTitleIndonesia,mDescIndonesia,mTitleEng,mDescEng,mTitleSpec,mDescSpec;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hadaly);

        mTitleHadaly = findViewById(R.id.hadaly_title);
        mTitleIndonesia = findViewById(R.id.hadaly_indonesia);
        mDescIndonesia = findViewById(R.id.hadaly_desc);
        mTitleEng = findViewById(R.id.hadaly_english);
        mDescEng = findViewById(R.id.hadaly_desceng);
        mTitleSpec = findViewById(R.id.hadaly_specTitle);
        mDescSpec = findViewById(R.id.hadaly_specDesc);

        Typeface customFont = Typeface.createFromAsset(getAssets(),"font/BebasNeue.ttf");
        mTitleHadaly.setTypeface(customFont);
